...
const navItems = [
  { label: 'Myria Agent', href: '/about-myria' },
  { label: 'Virtual Team', href: '/virtual-advisory-team' },
  { label: 'Advisory Lab', href: '/advisory-lab' },
  { label: 'Contact Agent', href: '/contact-myria' },
]
